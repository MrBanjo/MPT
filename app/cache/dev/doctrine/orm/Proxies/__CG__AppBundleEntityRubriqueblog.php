 ...
 */
class Rubriqueblog extends \AppBundle\Entity\Rubriqueblog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Rubriqueblog' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Rubriqueblog' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Rubriqueblog' . "\0" . 'blogs');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Rubriqueblog $proxy) {
