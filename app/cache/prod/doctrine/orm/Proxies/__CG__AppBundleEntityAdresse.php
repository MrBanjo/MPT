 ...
 */
class Adresse extends \AppBundle\Entity\Adresse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'voie', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'ville', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'postal', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'complement', '' . "\0" . 'AppBundle\\Entity\\Adresse' . "\0" . 'titre');
        }
    ...
    public function setVoie($voie)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVoie', array($voie));

        return parent::setVoie($voie);
    }
    ...
    public function getVoie()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVoie', array());

        return parent::getVoie();
    }
