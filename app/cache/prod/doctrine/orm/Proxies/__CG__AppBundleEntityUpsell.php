 ...
 */
class Upsell extends \AppBundle\Entity\Upsell implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'prix', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'origine', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'departement', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'contenance', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'actif', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'categorie', '' . "\0" . 'AppBundle\\Entity\\Upsell' . "\0" . 'caddies');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Upsell $proxy) {
    ...
    public function setContenance($contenance)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContenance', array($contenance));
    ...
    public function getContenance()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContenance', array());
